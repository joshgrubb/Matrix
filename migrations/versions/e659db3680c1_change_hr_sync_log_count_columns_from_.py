"""Change hr_sync_log count columns from BIT to INT

Revision ID: e659db3680c1
Revises: f96dbbf2311e
Create Date: 2026-02-20 07:54:19.427008
...
revision = 'e659db3680c1'
down_revision = 'f96dbbf2311e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('cost_data', sa.Text(), nullable=False),
